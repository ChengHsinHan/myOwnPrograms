...
# midpoint of their opposite sides. The three medians of a triangle intersect at
# the same point, called the barycenter or the centroid. Given a triangle,
...
def bar_triang(point_a, point_b, point_c):
    return [round(sum(coordinate) / 3, 4) for coordinate in zip(point_a, point_b, point_c)]
