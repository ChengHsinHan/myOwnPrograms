...
# litres, up to a maximum discount of 25 cents per litre. But total discount per
# litre cannot be more than 25 cents. Return the total cost rounded to 2 decimal
# places. Also you can guess that there will not be negative or non-numeric
# inputs.
#
# Good Luck!
#
